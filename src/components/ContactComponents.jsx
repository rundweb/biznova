    ...
    <section className="container-primary min-h-screen flex items-center justify-center w-full py-16 flex-col gap-16 font-ns">
      <div className="flex w-full items-center justify-center flex-col gap-5 text-center">
        <div className="contact-p">
          <p className="button-blue rounded-full font-semibold text-lg">
            <BsStars /> Contact Us
          </p>
        </div>
      ...
      <div className="flex flex-col gap-10 items-center justify-center w-full lg:flex-row">
        <div className="w-full relative p-5  sm:max-w-lg contact-box overflow-hidden">
          ...
          <div className="w-full bg-blue-50 rounded-lg p-5 md:py-10 flex flex-col gap-5 relative z-10 items-center justify-center">
            <div className="w-full p-5  bg-white flex flex-wrap items-center justify-between gap-4 rounded-lg contact-box">
              <div>
        ...
        <div className="w-full">
          <div className="bg-blue-50 p-5 py-8 rounded-lg flex flex-col gap-4 contact-form overflow-hidden">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 contact-form">
              <div className="w-full relative group">
                <input
                  type="text"
                  placeholder="First Name"
                  className="w-full h-12 rounded-lg outline-primary p-5 text-font-primary"
                />
              </div>
              <div className="w-full relative group">
                <input
