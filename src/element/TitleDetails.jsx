...
const TitleDetails = ({ texth1, texth2 }) => {
  ...
  return (
    <div className="bg-details w-full h-full bg-no-repeat bg-cover bg-center mb-5 flex items-center justify-center rounded-lg shadow-lg py-5 md:py-20 text-center blog-title">
