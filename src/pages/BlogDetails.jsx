      ...
      <section className="container-primary min-h-screen font-ns mt-20 flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-10">
          <div className="w-full mx-auto p-6 h-max bg-third shadow-lg rounded-lg md:col-span-2 detail-blog">
            ...
            />
            <h1 className="text-3xl font-bold mt-4 detail-blog">{blogItem.title}</h1>
            <p className="text-sm text-font-primary/70 mt-4 detail-blog">
              {blogItem.date} • {blogItem.category}
            </p>
            <div className="mt-4 text-gray-700 detail-blog">
          ...
          <div className="w-full  gap-5 md:gap-10 flex flex-col">
            ...
            <div className="w-full h-max mx-auto p-5 bg-third shadow-lg rounded-lg flex items-center justify-center flex-col gap-5 detail-writer">
              <img
                src={detailIMg}
