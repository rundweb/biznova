    ...
    <div>
      <section className="container-primary min-h-screen font-ns mt-20 flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 md:gap-10 ">
          <div className="w-full mx-auto p-5 py-8 shadow-lg md:col-span-3 service-content overflow-hidden">
          ...
          <div className="w-full h-max p-5 py-8 shadow-lg  rounded-lg flex flex-col gap-5 text-center service-logo overflow-hidden">
